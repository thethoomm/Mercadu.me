                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tabelaProdutos" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Nome</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="100">Total de produtos: <?= count($lista)?></th>
                                        </tr>
                                    </tfoot>
                                    <tbody>
